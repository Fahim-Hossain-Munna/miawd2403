                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                ...
                                <?php else : ?>
                                    <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am Fahim Hossain Munna</h2>
                                <?php endif; ?>
                                ...
                                <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                    <ul>
                                        ...
                                        <li><a target="_blank" href="<?= $link['instagram'] ?>"><i class="fab fa-twitter"></i></a></li>
                                        <li><a target="_blank" href="<?= $link['twitter'] ?>"><i class="fab fa-instagram"></i></a></li>
